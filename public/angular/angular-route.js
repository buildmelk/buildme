    ...
    link: function(scope, $element, attr, ctrl, $transclude) {
        ...
        function update() {
          ...
          if (angular.isDefined(template)) {
            ...
            // Note: This will also link all children of ng-viewEnglish that were contained in the original
            // html. If that content contains controllers, ... they could pollute/change the scope.
            // However, using ng-viewEnglish on an element with additional content does not make sense...
